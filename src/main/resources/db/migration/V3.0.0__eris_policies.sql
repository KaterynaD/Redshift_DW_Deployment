...
- initial version
2022-11-14: KD
- AltSubTypeCd added for Safeguard policies
*/
...
comment on column ${deployment_schema}.vmeris_policies.AltSubTypeCd is 'The same as PolicyFormCd almost in all cases except HO3-Homegurad as on 2022/06';	
...
2022-11-14: KD
- 11 years of data are loaded into tables
- Safeguard (AltSubTypeCd) policies specific coverages are taken into account in Eearned Exposures calculation 
*/
